...
col_names = ['Id',
             ...
             'Price', 'Cabin',
             'Station']
path = r'C:\source_data\02 122.csv'
file_out = r'C:\generation_results\01 122.csv'
f = pd.read_csv(path, encoding='cp1251', error_bad_lines=False)
print(f.to_csv(file_out,
               sep=';',
               index=False,
               encoding='cp1251',
               date_format='str'))
